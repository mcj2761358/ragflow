#!/usr/bin/env python3
"""
RAGFlow Server Debug Launcher for PyCharm
用于在PyCharm中调试RAGFlow服务器的启动脚本
"""
...
def main():
    """主函数"""
    print("=" * 60)
    print("RAGFlow Server Debug Launcher")
    print("=" * 60)
    ...
    try:
        ...
        # 启动服务器 - 直接执行ragflow_server.py的主逻辑
        import runpy
        sys.argv = ['ragflow_server.py']
        runpy.run_path('api/ragflow_server.py', run_name='__main__')
